            ...
            <div class="row">
                ...
                <div class="col-md-2 user-sect">
                    ...
                    <div style=" text-align:center; padding:10px;">
                        ...
                        <p style="padding:0; margin:0;" p>Posts: {{$post->bestReply->user['posts']->count()}}</p>
        ...
        <div class="card-body">
            ...
            <form action="{{route('comment',  $post)}}" method="post" style="width:90%; padding-top:20px; margin:auto;">
                ...
                <div class="form-group">
                    ...
                    <textarea style="resize:none" class="form-control" name="comment" id="editor" rows="2"></textarea>
                    @error('description')
